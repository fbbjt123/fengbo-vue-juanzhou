<template>
    <div class="main">
        ...
        <header id="head">
            <!-- 个人中心  start-->
            <div class="userTop">
                <router-link to="/home/shopping" tag="div" class="userTop-left">
                    <svg 
                        class="icon"
                        width="25px"
                        height="25.00px"
